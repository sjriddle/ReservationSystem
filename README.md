...
- After the webserver is started, open up a browser and go to `http://10.52.2.41/ReservationSystem/public`. This should direct you to the main page of the current reservation system.
